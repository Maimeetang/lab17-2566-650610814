...
export const DELETE = async (request) => {
  ...
  const foundIndex = DB.enrollments.findIndex((x) => x.studentId === studentId);

  if (!foundStudent || foundStudent.courseNo !== courseNo)
    return NextResponse.json(
      {
        ok: false,
  ...
  //perform deletion by using splice or array filte
